...
#    :return: S_OK() || S_ERROR()
  ...
  # SAMTestCache methods ......................................................
 
  def selectSAMResultCache( self, elementName = None, testType = None, elementType = None,
                          status = None, log = None, jobID = None, submissionTime = None,
                          completionTime = None, applicationTime = None, meta = None ):
    return self._query( 'select', 'SAMResultCache', locals() )


  def deleteSAMResultCache( self, elementName = None, testType = None, elementType = None,
                          status = None, log = None, jobID = None, submissionTime = None,
                          completionTime = None, applicationTime = None, meta = None ):
    return self._query( 'delete', 'SAMResultCache', locals() )


  def addOrModifySAMResultCache( self, elementName = None, testType = None, elementType = None,
                               status = None, log = None, jobID = None, submissionTime = None,
                               completionTime = None, applicationTime = None, meta = None ):
    meta = { 'onlyUniqueKeys' : True }
    queryRes =  self._query( 'addOrModify', 'SAMResultCache', locals() )
    
    if queryRes[ 'OK' ]:
        args = locals()
        del args['queryRes' ]
        historyRecord = self._query( 'insert', 'SAMResultHistory', args )
        if not historyRecord[ 'OK' ]:
            return historyRecord
    
    return queryRes


  # ResourceSAMStatusCache methods ......................................................
  
  def selectResourceSAMStatusCache( self, elementName = None, elementType = None,
                                    tests = None, sAMStatus = None, lastUpdateTime = None, meta = None ):
    return self._query( 'select', 'ResourceSAMStatusCache', locals() )


  def deleteResourceSAMStatusCache( self, elementName = None, elementType = None,
                                    tests = None, sAMStatus = None, lastUpdateTime = None, meta = None ):
    return self._query( 'delete', 'ResourceSAMStatusCache', locals() )


  def addOrModifyResourceSAMStatusCache( self, elementName = None, elementType = None,
                                         tests = None, sAMStatus = None, lastUpdateTime = None, meta = None ):
    meta = { 'onlyUniqueKeys' : True }
    queryRes =  self._query( 'addOrModify', 'ResourceSAMStatusCache', locals() )
    
    if queryRes[ 'OK' ]:
        args = locals()
        del args['queryRes' ]
        historyRecord = self._query( 'insert', 'ResourceSAMStatusHistory', args )
        if not historyRecord[ 'OK' ]:
            return historyRecord
  ...
  # SiteSAMStatusCache methods ......................................................
  
  def selectSiteSAMStatusCache( self, site = None, siteType = None, sAMStatus = None,
                                cEStatus = None, sEStatus = None, lastUpdateTime = None, meta = None ):
    return self._query( 'select', 'SiteSAMStatusCache', locals() )


  def deleteSiteSAMStatusCache( self, site = None, siteType = None, sAMStatus = None,
                                cEStatus = None, sEStatus = None, lastUpdateTime = None, meta = None ):
    return self._query( 'delete', 'SiteSAMStatusCache', locals() )


  def addOrModifySiteSAMStatusCache( self, site = None, siteType = None, sAMStatus = None,
                                     cEStatus = None, sEStatus = None, lastUpdateTime = None, meta = None ):
    meta = { 'onlyUniqueKeys' : True }
    queryRes =  self._query( 'addOrModify', 'SiteSAMStatusCache', locals() )
    
    if queryRes[ 'OK' ]:
        args = locals()
        del args['queryRes' ]
        historyRecord = self._query( 'insert', 'SiteSAMStatusHistory', args )
        if not historyRecord[ 'OK' ]:
            return historyRecord
  ...
  # SiteSAMStatusHistory methods ......................................................
  
  def insertSiteSAMStatusHistory( self, site = None, siteType = None, sAMStatus = None,
                                cEStatus = None, sEStatus = None, interval = None, lastUpdateTime = None, meta = None ):
    return self._query( 'insert', 'SiteSAMStatusHistory', locals() )
  
  def selectSiteSAMStatusHistory( self, site = None, siteType = None, sAMStatus = None,
                                cEStatus = None, sEStatus = None, interval = None, lastUpdateTime = None, meta = None ):
    return self._query( 'select', 'SiteSAMStatusHistory', locals() )
