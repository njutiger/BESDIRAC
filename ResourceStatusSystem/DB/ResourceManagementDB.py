...
class ResourceManagementDB( object ):
  ...
  _tablesDB[ 'SAMResultCache' ] = { 'Fields' :
                     {
                       ...
                       'ApplicationTime'    : 'INTEGER NOT NULL DEFAULT 0',
                     },
                     'PrimaryKey' : [ 'ElementName' , 'TestType' ]
                                }
  
  _tablesDB[ 'SAMResultHistory' ] = { 'Fields' :
                     {
  ...
  _tablesDB[ 'SiteSAMStatusCache' ] = { 'Fields' : 
                     {
                       'Site' : 'VARCHAR(32) NOT NULL',
                       'SiteType' : 'VARCHAR(8) NOT NULL',
                       'SAMStatus' : 'VARCHAR(8) NOT NULL DEFAULT ""',
  ...
  _tablesDB[ 'SiteSAMStatusHistory' ] = { 'Fields' : 
                     {
                       'ID'  : 'BIGINT UNSIGNED AUTO_INCREMENT NOT NULL',
                       'Site' : 'VARCHAR(32) NOT NULL',
                       'SiteType' : 'VARCHAR(8) NOT NULL',
                       ...
                       'CEStatus' : 'VARCHAR(8) NOT NULL DEFAULT ""',
                       'SEStatus' : 'VARCHAR(8) NOT NULL DEFAULT ""',
                       'Interval' : 'VARCHAR(8) NOT NULL DEFAULT "hour"',
                       'LastUpdateTime' : 'DATETIME NOT NULL',
                     },
                     'PrimaryKey' : [ 'ID' ]
                                }
  
  _tablesDB[ 'ResourceSAMStatusCache' ] = { 'Fields' : 
                     {
                       'ElementName' : 'VARCHAR(64) NOT NULL',
                       'ElementType' : 'VARCHAR(16) NOT NULL',
  ...
  _tablesDB[ 'ResourceSAMStatusHistory' ] = { 'Fields' : 
                     {
                       'ID'  : 'BIGINT UNSIGNED AUTO_INCREMENT NOT NULL',
                       'ElementName' : 'VARCHAR(64) NOT NULL',
                       'ElementType' : 'VARCHAR(16) NOT NULL',
